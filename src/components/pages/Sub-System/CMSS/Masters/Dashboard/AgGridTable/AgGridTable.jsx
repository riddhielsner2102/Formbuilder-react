...
export default function AgGridTable() {
  ...
  useEffect(async () => {
    ...
    const API = `${requests.getForms}?UserID=${UserID}&AppID=13`;
    const apiresponse = await PrepareRequest(API);
  console.log("dataaaa", apiresponse.data.lstModelForms);
    // const response = await PrepareRequest(URL);
    // console.log("response", response.data);
    setdata(apiresponse.data.lstModelForms);
  }, []);
  useEffect(() => {
